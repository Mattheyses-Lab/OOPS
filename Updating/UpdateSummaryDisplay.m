function [] = UpdateSummaryDisplay(source,varargin)
    ...
    switch PODSData.Settings.SummaryDisplayType
        case 'Project'
            PODSData.Handles.ProjectDataTable.Text = {...
                ['<b>Project: </b>',PODSData.ProjectName];...
        ...
        case 'Group'
            ...
            if isempty(cGroup)
                ...
                PODSData.Handles.ProjectDataTable.Text = {...
                    ...
                    ['FFC Files Loaded:     ', Logical2String(cGroup.FFCLoaded)];...
                    ['FPM Files Loaded:     ', Logical2String(cGroup.FPMFilesLoaded)];...
        ...
        case 'Image'
            ...
            PODSData.Handles.ProjectDataTable.Text = {['<b>Image: </b>',cReplicate.pol_shortname];...
                ...
                ['Azimuth Stats Calculated: ', Logical2String(cReplicate.ObjectAzimuthDone)]};
        ...
        case 'Object'
            ...
            PODSData.Handles.ProjectDataTable.Text = {'<b>Object Summary</b>';...
                [cObject.Name];...
                ['Label:                ', cObject.Label.Name];...
                ['Average OF:           ', num2str(cObject.OFAvg)];...
                ['Area:                 ', num2str(cObject.Area)];...
                ['Convex Area:          ', num2str(cObject.ConvexArea)];...
                ['Perimeter:            ', num2str(cObject.Perimeter)];...
                ['Circularity:          ', num2str(cObject.Circularity)];...
                ['Eccentricity:         ', num2str(cObject.Eccentricity)];...  
                ['Orientation:          ', num2str(cObject.Orientation)];...
                ['Extent:               ', num2str(cObject.Extent)];...
                ['Solidity:             ', num2str(cObject.Solidity)];...
                ...
                ['Original Idx:         ', num2str(cObject.SelfIdx)];...
                ['Azimuth Average:      ', num2str(cObject.AzimuthAverage)];...
                ['Azimuth Std. Dev.:    ', num2str(cObject.AzimuthStd)];...
                ['Azimuth wrt Midline:  ', num2str(cObject.MidlineRelativeAzimuth)];...
                ['Azimuth wrt Normal:   ', num2str(cObject.NormalRelativeAzimuth)];...
                ['Tortuosity:           ', num2str(cObject.Tortuosity)];...
                ['Midline Length:       ', num2str(cObject.MidlineLength)];...
                ['Midline Tangent Avg:  ', num2str(cObject.TangentAverage)]};
