...
%
% DESCRIPTION:
%   Given a list of unsorted points representing an unclosed curve and one 
%   endpoint of the curve, recursively reorder the points by finding the 
