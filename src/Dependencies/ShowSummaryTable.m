...
% get the stacked data tables and concatenate them
stackedDataTables = OOPSData.stackedObjectDataTable();
T = cat(1,stackedDataTables(:).Data);

% new figure to show summary table
SummaryFig = uifigure('Position',OOPSData.Settings.ScreenSize);
