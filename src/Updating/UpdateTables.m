...
% I think this function can be removed %
    ...
    cGroupIndex = OOPSData.CurrentGroupIndex;
    cGroup = OOPSData.CurrentGroup;
    
    
    % in case no images exist for current group
    try
        cReplicate = OOPSData.CurrentImage(1);
    catch
        OOPSData.Handles.ProjectDataTable.Text = {['Load some data to see summary...']};
        return
    end
    
    if cReplicate.nObjects == 0
 
        OOPSData.Handles.ProjectDataTable.Text = {['<b>Project: </b>',OOPSData.ProjectName];...
                                         ['Number of Groups:     ', num2str(OOPSData.nGroups)];...
                                         ['Input File Type:      ', OOPSData.Settings.InputFileType];...
                                         ['Current Tab:          ', OOPSData.Settings.CurrentTab];...
                                         ['Previous Tab:         ', OOPSData.Settings.PreviousTab];...
