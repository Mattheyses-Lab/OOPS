...
switch OOPSData.Settings.SwarmPlotGroupingType
    ...
    %% gather the data
        ...
        ObjectGroupNames = OOPSData.GetObjectDataByGroup('texFriendlyGroupName');
    ...
    %% gather the data
        ...
        ObjectGroupNames = cGroup.GetObjectDataByLabel('texFriendlyGroupName');
    ...
    %% gather the data
        ...
        % get object GroupName for data tips
        ObjectGroupNames = OOPSData.GetObjectDataByGroupAndLabel('texFriendlyGroupName')';
        % get object ImageName for data tips
...
groupNames = cellfun(@(n) convertCharsToStrings(strjoin(strsplit(n,'_'),"\_")),groupNames,'UniformOutput',false);
