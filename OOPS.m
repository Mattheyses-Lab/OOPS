...
% OOPSData.Handles.SettingsAccordion.Items(1).PaneBackgroundColor = [0 0 0];
% OOPSData.Handles.SettingsAccordion.Items(1).Title = 'Colormaps';
% OOPSData.Handles.SettingsAccordion.Items(1).FontName = OOPSData.Settings.DefaultFont;
% OOPSData.Handles.SettingsAccordion.Items(1).FontColor = OOPSData.Settings.GUIForegroundColor;
% OOPSData.Handles.SettingsAccordion.Items(1).TitleBackgroundColor = OOPSData.Settings.GUIBackgroundColor;
% OOPSData.Handles.SettingsAccordion.Items(1).PaneBackgroundColor = OOPSData.Settings.GUIBackgroundColor;
% OOPSData.Handles.SettingsAccordion.Items(1).BorderColor = OOPSData.Settings.GUIForegroundColor;
...
disp('Setting up object image axes...')
    ...
    % OOPSData.Handles.ObjectIntensityProfileGrid = uigridlayout(OOPSData.Handles.ImgPanel2,[2,1],...
    %     'Padding',[0 0 0 0],...
    %     'BackgroundColor',OOPSData.Settings.ObjectIntensityProfileBackgroundColor,...
    %     'Tag','ObjectIntensityProfileGrid',...
    %     'Visible','Off',...
    %     'ColumnWidth',{'1x'},...
    %     'RowHeight',{'1x','3x'},...
    %     'RowSpacing',0);
    ...
    OOPSData.Handles.ObjectIntensityPlotAxH = uiaxes(OOPSData.Handles.ImgPanel2,...
        ...
        'FontName',OOPSData.Settings.DefaultPlotFont);
    %OOPSData.Handles.ObjectIntensityPlotAxH.Layout.Row = 2;
