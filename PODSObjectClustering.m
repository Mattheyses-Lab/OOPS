function ClusterIdxs = PODSObjectClustering(ObjectData,nClusters,nReplicates,VariablesList,VariablesToPlot)
...
%% Euclidean distance k-means clustering (with more replicates)    
