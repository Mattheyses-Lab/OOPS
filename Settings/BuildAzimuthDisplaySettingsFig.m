function BuildAzimuthDisplaySettingsFig()
    ...
    try
        ...
        AzimuthDisplaySettings.ColorMode = 'Direction';
    end
    ...
    MyGrid = uigridlayout(fHAzimuthSettings,[6,2]);
    MyGrid.Padding = [10,20,10,20];
    MyGrid.RowSpacing = 20;
    MyGrid.ColumnSpacing = 10;
    MyGrid.RowHeight = {20,20,20,20,20,20};
    ...
    AzimuthColorModeLabel = uilabel('Parent',MyGrid,'Text','Line color mode (default: Direction)');
    AzimuthColorModeDropdown = uidropdown('Parent',MyGrid,...
        'Items',{'Direction','Magnitude','Mono'},...
        'Value',AzimuthDisplaySettings.ColorMode);
    ...
    function SaveAzimuthSettings(~,~)
        if ismac
            ...
            AzimuthDisplaySettings.LineScale = str2double(AzimuthLineScaleEditfield.Value);
            AzimuthDisplaySettings.ScaleDownFactor = AzimuthLineScaleDownDropdown.Value;
            AzimuthDisplaySettings.ColorMode = AzimuthColorModeDropdown.Value;
    ...
    function LoadAzimuthDisplaySettings(source,~)
        ...
        try
            ...
            AzimuthColorModeDropdown.Value = AzimuthDisplaySettings.ColorMode;
        catch
            disp('Failed to load "AzimuthDisplaySettings.mat", proceeding with default settings...');
            ...
            AzimuthColorModeDropdown.Value = 'Direction';
        end
