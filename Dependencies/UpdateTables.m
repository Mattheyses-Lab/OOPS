function [] = UpdateTables(source)
    ...
    if cReplicate.nObjects == 0
        ...
        PODSData.Handles.ProjectDataTable.Text = {['<b>Project Overview</b>'];...
                                         ...
                                         ['Number of Channels:   ', num2str(PODSData.nChannels)];...
                                         ['Current Channel:      ', cGroup.ChannelName];...
                                         ['                      '];...
                                         ['<b>Group Summary</b>'];...
                                         [cGroup.GroupName];...
                                         ...
                                         ['<b>Colocalization Results</b>'];...
                                         ['Pearsons(Raw):        ', num2str(cReplicate.RawAllPixelPearsons)];...
                                         ['Obj Pearsons:         ', num2str(cReplicate.ObjectPearsons)];...
                                         ['<b>Status</b>'];...
    ...
    PODSData.Handles.ProjectDataTable.Text = {['<b>Project Overview</b>'];...
                                     ...
                                     ['Avg. Coloc. Intensity:', num2str(cObject.AvgColocIntensity)];...
                                     ['Single Obj. Pearsons: ', num2str(cObject.ROIPearsons)]};
