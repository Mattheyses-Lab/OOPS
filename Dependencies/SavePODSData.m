    ...
    for i = 1:PODSData.nGroups
        for j = 1:PODSData.Group(i).nReplicates
            for k = 1:PODSData.Group(i).Replicate(j).nObjects
                ...
                PODSDataOut(MasterIdx).ObjectAvgAzimuth = PODSData.Group(i).Replicate(j).Object(k).AzimuthAverage;
                PODSDataOut(MasterIdx).ObjectAzimuthStd = PODSData.Group(i).Replicate(j).Object(k).AzimuthStd;
